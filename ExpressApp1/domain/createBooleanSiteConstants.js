...
class BooleanSiteConstants {
    ...
    setConstantValue(i, constantValue) {
        if (i < this.constantValues.length) {
            if (constantValue == "true" || constantValue == "false") {
    ...
    toString() {
        var start = '\tpublic static final Boolean ';
        var end = ';\n';
    ...
    toHtmlString() {
        var start = '<p>public static final Boolean ';
        var end = ';</p>';
...
module.exports = BooleanSiteConstants;
